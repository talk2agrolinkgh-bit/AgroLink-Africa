...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  { url: `${SITE_URL}/market`, changeFrequency: "daily", priority: 0.9, lastModified: now },
  { url: `${SITE_URL}/farm`, changeFrequency: "weekly", priority: 0.8, lastModified: now },
  { url: `${SITE_URL}/academy`, changeFrequency: "weekly", priority: 0.8, lastModified: now },
  { url: `${SITE_URL}/sourcing`, changeFrequency: "monthly", priority: 0.7, lastModified: now },
  { url: `${SITE_URL}/list-product`, changeFrequency: "monthly", priority: 0.7, lastModified: now },
  { url: `${SITE_URL}/how-it-works`, changeFrequency: "monthly", priority: 0.5, lastModified: now },
